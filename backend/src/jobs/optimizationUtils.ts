...
export const SELECTABLE_COMBINATIONS = [
...
export function generateNumericRanges(thresholds: (number | null)[], mode: string) {
    const ranges: any[] = [];
...
export function applyFilters(trades: Trade[], combination: any) {
...
export function calculateMetricsForAllStrategies(trades: Trade[], ltaCombination: boolean, settings: any, combo: any) {
...
export function calculateCompositeScore(metrics: any, weights: any) {
...
export function applyPredefinedFilters(trades: Trade[], filters: any[]): Trade[] {
