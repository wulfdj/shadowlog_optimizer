<template>
  <v-container fluid>
    ...
    <v-tabs v-model="selectedTimeframe" bg-color="surface" class="mb-4">
    ...
    <div style="height: 75vh; width: 100%;">
      <ag-grid-vue :theme="myTheme" :columnDefs="columnDefs" :defaultColDef="defaultColDef"
        @grid-ready="onGridReady" style="width: 100%; height: 100%;"></ag-grid-vue>
    </div>
